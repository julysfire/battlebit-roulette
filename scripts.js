...
function getRandomLoadout(){
    ...
    //Apply all to page
    var scopeTextMain = "Main Scope: " + mainScopes[0];
    if(mainScopes[1] != null){
        var cantedScope = "Canted Scope: " + mainScopes[1];
    }
    if(mainScopes[2] != null && ["1 P78", "Echo", "T R I4 X32", "Burris A R332"].includes(mainScopes[0]) == false){
        var topScope = "Top Scope: " + mainScopes[2];
    }


        //Weps
    document.getElementById('randomWepMain').innerHTML = "Main Weapon: " + main_wep;
    document.getElementById('randomWepSec').innerHTML = "Secondary Weapon: " + sec_wep;

        //Scopes
    document.getElementById('randomMainScopes').innerHTML = "Main Scope: " + mainScopes[0];

    if(cantedScope != undefined){
    ...
    document.getElementById('randomSecScope').innerHTML = "Scope: " + secondaryScope;

        //Barrel
    document.getElementById('randomMainBarrel').innerHTML = "Barrel: " + mainBarrel;
    document.getElementById('randomSecBarrel').innerHTML = "Barrel: " + secBarrel;

        //Grip
    document.getElementById('randomMainGrip').innerHTML = "Grip: " + mainGrip;

        //Side Rails
    document.getElementById('randomMainSide').innerHTML = "Side Rail: " + mainSiderail;
    document.getElementById('randomSecSide').innerHTML = "Side Rail: " + secSiderail;

        //Mag
    document.getElementById('randomMainMag').innerHTML = "Magazine: " + mainMag;
    document.getElementById('randomSecMag').innerHTML = "Magazine: " + secMag;

        //Bolt
    if(mainBolt != null){
        document.getElementById('randomMainBolt').innerHTML = "Bolt: " + mainBolt;
    }else{
...
function getMainScopes(){
    ...
    if(randScopeId == "iron"){
        ...
        var scope_main = scope_main_list[Math.floor(Math.random() * jsonData["scopes_id"].length)];
